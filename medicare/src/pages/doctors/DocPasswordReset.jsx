...
function DocPasswordReset() {
      ...
      <div className="w-full md:w-1/2 flex flex-col items-start px-10">
        ...
        <div className="w-full flex flex-col items-center mb-6">
          ...
          <p className="text-gray-500 mt-1 text-center">
            Enter Your Doctor Register Email to get a Pass code for Your
            Password Reset
          </p>
        </div>
  ...
  focus-within:border-blue-500 focus-within:ring-2 focus-within:ring-blue-300 transition-all"
        ...
        <button className="w-full bg-[#024F9D] hover:bg-[#0363c2] transition-all text-white text-lg font-semibold py-4 rounded-xl mb-6">
          <Link to={"/docverifypass"} className="text-blue-600 font-semibold">
            Verify
          </Link>
        </button>
        ...
        <p className="text-gray-500 text-center w-full">
          Remember Password?{" "}
          <Link to={"/doclogin"} className="text-blue-600 font-semibold">
            Login
          </Link>
        </p>
...
export default DocPasswordReset;
