import { Home, AlertCircle, FileText, Heart, Calendar, Phone, BellRing, Folder, User, Settings, LogOut } from "lucide-react";
  ...
  return (
    <div className="w-80 bg-[#1e40af] text-white min-h-screen flex flex-col">
      ...
      <nav className="flex-1 px-6">
        <p className="text-blue-300 text-xs font-semibold uppercase tracking-wider mb-3">Main Menu</p>
        ...
        <p className="text-blue-300 text-xs font-semibold uppercase tracking-wider mt-8 mb-3">More</p>
        <a href="#" className="flex items-center gap-4 px-5 py-4 rounded-xl hover:bg-blue-700 transition-all">
